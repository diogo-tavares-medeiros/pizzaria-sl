...
const botoesFechar = () => {
  ...
  // fecharModal()
  // })
  selecionaTodos(' .pizzaInfo--cancelButton, .pizza-Info--cancelMobileButton'
  ).forEach((item) => {
...
const adicionarNoCarrinho = () => {
    seleciona(' .pizzaInfo--addButton').addEventListener('click', () => {
        ...
        let identificar = pizzaJson[modalKey].id+'t'+size

        let key = cart.findIndex( (item) => item.identificar == identificar )
        console.log(key)
